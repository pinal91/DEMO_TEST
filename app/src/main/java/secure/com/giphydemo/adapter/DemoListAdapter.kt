...
class DemoListAdapter(private val dataList: ArrayList<DataItem?>, private val context: Context?)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (dataList[position]?.imageHref.equals("null")||dataList[position]?.imageHref.isNullOrEmpty()){
            holder.itemView.imgLawfirm.visibility=View.GONE
        }

        Picasso.with(context).load(dataList[position]?.imageHref).into(holder.itemView.imgLawfirm, object : Callback {
